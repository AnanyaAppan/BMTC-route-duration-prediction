...
def get_grid(lat_test, long_test):
    ...
    grid_lenght_lat = length_lat/10
    grid_lenght_long = length_long/10
    subgrid_i = int(((lat_test-grid_lat)/grid_lenght_lat))
    subgrid_j = int(((long_test-grid_long)/grid_lenght_long))
