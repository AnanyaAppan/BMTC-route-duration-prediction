...
#         else : 
#             i = 0
#             speed1 = pdf.iloc[0].speed
#             while(speed1 == 0 and i<len(pdf)):
#                 i += 1
...
#         else : 
#             i = 0
#             speed2 = pdf.iloc[0].speed
#             while(speed2 == 0 and i<len(pdf)):
#                 i += 1
...
for chunk in pd.read_csv('/home/ananya/Documents/BMTC/test.csv', header=None, chunksize=chunksize,skiprows=1):
    ...
    f_time = 23
    f_timestamp = "khafhkaj"
    data = {"final_time" : [f_time], "final_timestamp" : [f_timestamp]}
    df.insert(102,"final_time",[f_time])
    df.insert(103,"final_timestamp",[f_timestamp])
    df.to_csv("/home/ananya/Documents/BMTC/final/bigFiles/test_final.csv",header=False, index=False,mode='a')
