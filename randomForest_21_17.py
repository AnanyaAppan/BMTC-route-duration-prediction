...
train = pd.read_csv('/home/ananya/Documents/BMTC/sorted_encoded_data/final_encoded.csv', header=None, nrows = 10000)
...
train.to_csv("/home/ananya/Documents/BMTC/final/fitted.csv")
