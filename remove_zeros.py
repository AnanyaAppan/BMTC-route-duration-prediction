...
chunk = pd.read_csv("grid_21_17.csv", header=None, names = ["Index" ,"busId" , "latitude", "longitude", "angle", "speed", "timestamp"])
...
df.to_csv('grid_21_17_zero_removed.csv', mode='a', header=False, index = False)
